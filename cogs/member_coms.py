...
class Member_coms(commands.Cog):
  ...
  @slash_command(name="userinfo", description="Display information about someone, or yourself. This command isn't ephemeral.")
  ...
  @slash_command(name="roleinfo", description="Display information about someone's roles, or your roles. This command isn't ephemeral.")
  ...
  @slash_command(description="Display your avatar, or somebody else's.")
  ...
  @slash_command(description="Display any emoji of your choosing. Must be from a server the bot is in.")
  ...
  @slash_command(name="sticker", description="Display any sticker of your choosing. Must be from a server the bot is in.")
